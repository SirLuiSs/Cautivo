      ...
      <div class="x_content">
         <div class="row">
          ...
          <div class="col-md-2 col-sm-12 col-xs-12 xs-mb-10">
            <div class="xs-mt-25">
                  <button type="button" class="btn btn-success btn-app" onclick="filtrar_percepciones()" ><span class="fa fa-filter"></span>Filtrar</button>
            </div>
          </div>
          <div class="col-md-2 col-sm-12 col-xs-12 xs-mb-10">
            <div class="xs-mt-25">
        ...
        ?>
          ...
          <div class="col-md-2 col-sm-12 col-xs-12 xs-mb-10">
            <div class="xs-mt-25">
                  <button type="button" class="btn btn-success btn-app" onclick="filtrar_otros('lista_percepciones.php')"><span class="fa fa-filter"></span>Filtrar</button>
            </div>
          </div>
        </div>
      </div>
